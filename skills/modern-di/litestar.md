...
`ModernDIPlugin` handles everything:
...
Dependencies are wired **centrally** in `AppConfig.dependencies`. Route handlers just declare them as
plain parameters — no annotations or markers needed in the handler itself.
