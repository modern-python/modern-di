...
- **One caveat worth repeating:** apply `override()` / `reset_override()` and
  ...
  [`architecture/concurrency.md`](https://github.com/modern-python/modern-di/blob/2.30.0/architecture/concurrency.md).

## Docs & internals

- New [`architecture/concurrency.md`](https://github.com/modern-python/modern-di/blob/2.30.0/architecture/concurrency.md)
...
- Two GIL-caveat code comments now point at the capability page; a stale
  free-threading item was removed from the deferred queue as actioned.
