...
This release ships two PRs (#202, #203) driven by a full code-and-docs audit of the codebase. All audit findings are now resolved; none remain deferred for the main repo. The audit covered 57 findings across bugs, doc/code drift, internals, public-API DX, and documentation gaps.
