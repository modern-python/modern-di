...
def compile_resolver(
    ...
    if type(provider) is Factory and provider.cache_settings is None:
        return _compile_transient_factory(provider, registry)
    # BRIDGE (temporary, Tasks 3-4 replace these): route uncompiled types through the interpreted path.
