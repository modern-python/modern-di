...
def test_attr_getter_with_zero_attribute_depth_sync(
    ...
    assert attr_getter.sync_resolve(di_container) == Settings().some_str_value
...
async def test_attr_getter_with_zero_attribute_depth_async(
    ...
    assert await attr_getter.async_resolve(di_container) == Settings().some_str_value
...
def test_attr_getter_with_more_than_zero_attribute_depth_sync(
    ...
    assert attr_getter.sync_resolve(di_container) == Nested2().some_const
...
async def test_attr_getter_with_more_than_zero_attribute_depth_async(
    ...
    assert await attr_getter.async_resolve(di_container) == Nested2().some_const
